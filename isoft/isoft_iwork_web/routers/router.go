...
func loadloadIWorkerRouterDetail() {
	...
	beego.Router("/api/iwork/fileUpload", &controllers.WorkController{}, "get,post:FileUpload")
	...
	beego.Router("/api/iwork/getAllFilterWorks", &controllers.WorkController{}, "get,post:GetAllFilterWorks")
