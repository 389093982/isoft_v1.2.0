...
func initCMSRouter() {
	...
	beego.Router("/api/cms/filterElements", &cms.CMSController{}, "get,post:FilterElements")
	beego.Router("/api/cms/addElement", &cms.CMSController{}, "get,post:AddElement")
	beego.Router("/api/cms/filterElementByPlacement", &cms.CMSController{}, "get,post:FilterElementByPlacement")
...
func loadISSORouter() {
	...
	//beego.Router("/api/sso/user/login", &sso.LoginController{}, "post:PostLogin2")
