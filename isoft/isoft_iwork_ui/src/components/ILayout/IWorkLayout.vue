        ...
        <Sider hide-trigger :style="{background: '#fff'}">
          <Menu active-name="1-2" theme="light" width="auto" :open-names="['1']" accordion>
            <Submenu name="1">
              ...
              <MenuItem name="1-4"><router-link to="/iwork/migrateList">表迁移管理</router-link></MenuItem>
            ...
            <Submenu name="5">
              ...
              <MenuItem name="5-4"><router-link to="/iwork/template">自定义模板</router-link></MenuItem>
              <MenuItem name="5-5"><router-link to="/iwork/files">文件服务器管理</router-link></MenuItem>
            </Submenu>
          </Menu>
        </Sider>
