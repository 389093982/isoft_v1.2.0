...
// 编辑或者新增博客文章
export const BlogEdit = (id, blog_title, short_desc, key_words, catalog_id, content) => ajax(BASE_URL+'/iwork/httpservice/BlogEdit2',{id, blog_title, short_desc, key_words, catalog_id, content},'POST');
