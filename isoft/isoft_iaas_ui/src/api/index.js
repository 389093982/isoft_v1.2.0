...
export const AddPlacement = (placement_name, placement_desc, placement_title) => ajax(BASE_URL_2+'/iwork/httpservice/AddPlacement2',{placement_name, placement_desc, placement_title},'GET');
